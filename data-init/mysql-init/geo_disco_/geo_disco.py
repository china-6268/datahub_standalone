...
downstream_table = make_dataset_urn(platform="mysql", name="datahub.disco_sample", env="PROD")
...
upstream_tables = [
    make_dataset_urn(platform="mysql", name="datahub.geo_c_serie", env="PROD")
]
...
print("geo_c_serie 和 disco_sample 的血缘信息已成功提交")
